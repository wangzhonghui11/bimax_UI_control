...
def main():
    ...
    users_config = [
        ...
        {"id": 11, "port": 7861, "name": "用户1", "domain_id": 110,"ip":"192.168.2.195"},
        {"id": 12, "port": 7862, "name": "用户2", "domain_id": 120,"ip":"192.168.2.70"},
        {"id": 13, "port": 7863, "name": "用户3", "domain_id": 130,"ip":"192.168.2.135"},
        {"id": 14, "port": 7864, "name": "用户4", "domain_id": 140,"ip":"192.168.2.238"}
    ]
